...
,	m_bSrcInFocus( true )
{
	...
	//
	CFileHandler::RegisterExtension( "lua", CLUAFileHandler::Execute, CLUAFileHandler::Information );

	CFileHandler::RegisterExtension( "swf", CSWFFileHandler::Execute, CSWFFileHandler::Information );

	CFileHandler::RegisterExtension( "ini", CTextFileHandler::Execute, CTextFileHandler::Information );
	...
	CFileHandler::RegisterExtension( "html", CTextFileHandler::Execute, CTextFileHandler::Information );
	...
	CFileHandler::RegisterExtension( "sc68", CMusicFileHandler::Execute, CMusicFileHandler::Information );
	CFileHandler::RegisterExtension( "sid", CMusicFileHandler::Execute, CMusicFileHandler::Information );
	CFileHandler::RegisterExtension( "sap", CMusicFileHandler::Execute, CMusicFileHandler::Information );
	CFileHandler::RegisterExtension( "nsf", CMusicFileHandler::Execute, CMusicFileHandler::Information );

	CFileHandler::RegisterExtension( "avi", CMovieFileHandler::Execute, CMovieFileHandler::Information );
	CFileHandler::RegisterExtension( "mpeg", CMovieFileHandler::Execute, CMovieFileHandler::Information );
	CFileHandler::RegisterExtension( "mov", CMovieFileHandler::Execute, CMovieFileHandler::Information );
	CFileHandler::RegisterExtension( "mp4", CMovieFileHandler::Execute, CMovieFileHandler::Information );
...
void	CFileAssistant::ProcessInput()
{
	...
	CMusicFileHandler::ProcessInput();
}
