...
const CString		CSkinManager::s_szComponentNames[ MAX_SKIN_COMPONENTS ] =
{
	...
	"top_arrow.png",			// SC_ICON_SCROLLBAR_TOP_ARROW,
	"bottom_arrow.png",			// SC_ICON_SCROLLBAR_BOTTOM_ARROW,
	"scrollabr.png",			// SC_ICON_SCROLLBAR,
	"offset.png",				// SC_ICON_SCROLLBAR_OFFSET,
};
...
void	CSkinManager::SetCurrentSkin( const CString & skin_name )
{
	...
	//
	//	Upload any GPU critical textures
	//
	if ( CMusicFileHandler::IsPlaying() == true && CMusicFileHandler::VisualiserVisible() == true )
	{
	}
	else
	{
